...
<head>
    ...
    <!-- <body data-layout="horizontal"> -->
                            ...
                            <div class="">
                                <div class="p-4">
                                    <div class="text-center">
                                        <a href="{{ route('login') }}">
                                            <a style="font-size: 40px ;color: #01c273; text-decoration: none " href="{{ route('login') }}">
                                                Customer Login
                                            </a>
                                        </a>
                                    </div>
                                    @yield('customer_auth_content')
                                </div>
                            </div>
                        </div>
       ...
       @include('layouts.customer.auth.includes.js')
