                        ...
                        <div class="d-flex align-items-end mt-3 mt-sm-0">
                            <div class="flex-shrink-0">
                                <div class="avatar-xxl me-3">
                                    <img src="{{ asset('photo/user_profile') }}/{{ $customer->photo }}" alt="" class="img-fluid rounded-circle d-block img-thumbnail">
                                </div>
                            </div>
                            <div class="flex-grow-1">
                                <div>
                                    <h5 class="font-size-16 mb-1">{{ $customer->name }}</h5>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control pe-5 @error('password_confirmation') is-invalid @enderror"  name="name" placeholder="Enter Name" value="{{ $customer->name }}">
                                            @error('name')
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating mb-3">
                                            <input type="email" class="form-control pe-5 @error('password_confirmation') is-invalid @enderror"  name="email" placeholder="Enter email" value="{{ $customer->email }}">
                                            @error('email')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control pe-5 @error('phone') is-invalid @enderror"  name="phone" placeholder="Enter phone" value="{{ $customer->phone }}">
                                            @error('phone')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control pe-5 @error('address') is-invalid @enderror"  name="address" placeholder="Enter address" value="{{ $customer->address }}">
                                            @error('address')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
