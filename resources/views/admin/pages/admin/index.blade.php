                                 ...
                                 <tbody>
                                     @foreach($data['admins'] as $admin)
                                        <tr>
                                            ...
                                            <td style="width: 25%;">
                                                <img src="{{ asset('photo/profile') }}/{{ $admin->photo }}" alt="" class="avatar-sm rounded-circle me-2">
                                                {{ $admin->name }}
                                            </td>
                                            <td style="width:10%;">
    ...
    <script>
       $(document).ready(function() {
            ...
            $('.sweet_delete').click(function(){
                var delete_id = $(this).closest("tr").find('.admin_val_id').val();
                Swal.fire({
                  title: 'Are you sure?',
